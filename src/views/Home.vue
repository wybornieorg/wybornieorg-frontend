...
<div class="home">
  <div class="header">
    <div class="logo center">
      <a href="/"><img src="/img/icons/logo.svg" alt="">wybornie.org</a>
      <div class="social-links">
        <a v-for="(link, index) in socialLinks" :key="index" v-tooltip.bottom="link.name" target="_blank" :href="link.href">
  ...
  <!-- <router-link class="aplikacja" :to="{ name: 'main-app' }"><img src="/img/icons/logo.svg" alt="">Przejdź do aplikacji!</router-link> -->

  <!-- <about></about> -->
  <div class="">
    <h2>Co charakteryzuje <a href="/">wybornie.org</a>?</h2>
    <ul>
      <li>neutralność - opiera się na danych publicznych, nie zawiera opinii autora</li>
      <li>bezpieczeństwo - nie pobiera danych od użytkownika, nie ma rejestracji, nie ma skryptów śledzących, reklam</li>
      <li>otwartość - ma otwarty kod źródłowy</li>
...
.home > div {
  box-shadow: hsla(0, 0%, 0%, 0.1) 0 1vmin 2vmin 0;
  margin: 2vmin;
  padding: 2vmin;
  border-radius: 1vmin;
}
